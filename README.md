...
# Elastic Export ShippingProfiles Plugin for plentymarkets 7

This is the elastic export ShippingProfiles plugin for plentymarkets 7 which extends the list of possible export formats.
